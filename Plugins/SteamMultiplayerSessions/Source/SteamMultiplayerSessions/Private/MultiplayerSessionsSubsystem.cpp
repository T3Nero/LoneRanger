...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
	...
	// Store delegate in FDelegateHandle so it can be cleared later
...
void UMultiplayerSessionsSubsystem::StartSession()
{
	...
	StartSessionDelegateHandle = SessionInterface->AddOnStartSessionCompleteDelegate_Handle(StartSessionCompleteDelegate);
